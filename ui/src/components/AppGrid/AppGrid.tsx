...
const AppGrid: React.FC = () => {
  ...
  const appGridItems = [
    { title: "radio", backgroundColor: "white", textColor: "black", serviceLink: `df://radio-hub:${HUB_NODE}@radio:dartfrog:gliderlabs.os`, imageUrl: "https://bwyl.nyc3.digitaloceanspaces.com/radio/radio.png"},
